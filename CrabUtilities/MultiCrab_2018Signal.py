...
def submit(datasetdetail):
    print "submitting"
    print datasetdetail
    # os.system('crab submit -c crabConfig_2018_DATA.py General.requestName='+datasetdetail[0]+' Data.inputDataset='+datasetdetail[1])
    os.system('crab submit -c crabConfig_2018_MC.py General.requestName='+datasetdetail[0]+' Data.inputDataset='+datasetdetail[1])
...
# textfilename='DATASamples_2018.txt'
textfilename='MCSamples_2018.txt'
# textfilename='withoutRP_SignalSamples_2018.txt'
# textfilename='withRP_SignalSamples_2018.txt'
