...
def submit(datasetdetail):
    ...
    print datasetdetail
    os.system('crab submit -c crabConfig_2018_MC.py General.requestName='+datasetdetail[0]+' Data.inputDataset='+datasetdetail[1]+' Data.unitsPerJob='+datasetdetail[2])
...
textfilename='backgroundList_mc2018.txt'
