...
fout.write("test treeMaker_Summer16_cfg.py /MonoH-_ZpBaryonic_bb_MZp100_gq25_MDM100_hbb/shuxiao-MINIAODSIM-28028af67189b3de7224b79195bd0e1d/USER 1 \n")
...
def submit():
    ...
    for line in f:
        ...
        print datasetdetail
        if "USER" in datasetdetail[2]:
            print "It is a privately-produced dataset"
            os.system('crab submit General.requestName='+datasetdetail[0]+' JobType.psetName='+datasetdetail[1]+' Data.inputDataset='+datasetdetail[2]+' Data.unitsPerJob='+datasetdetail[3]+' Data.inputDBS=phys03')
        else:
