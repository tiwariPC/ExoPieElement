...
fout = open("datasetdetails_Spring16.txt","w")
...
fout.write("BulkGravToZZToZlepZhad_narrow_M-2000_13TeV-madgraph treeMaker_Summer16_cfg.py /BulkGravToZZToZlepZhad_narrow_M-2000_13TeV-madgraph/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_reHLT_80X_mcRun2_asymptotic_v14-v1/MINIAODSIM 1 \n")
...
def submit():
    print "submitting"
    f = open('datasetdetails_Spring16.txt','r')
    for line in f:
        print line
        a=[]
        b=[]
