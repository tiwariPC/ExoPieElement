#ifndef BOOSTEDBTAGGINGMVACALCULATOR_H
#define BOOSTEDBTAGGINGMVACALCULATOR_H

// -----------------------------------------------------------------------------------------------
// Raman Khurana
// 27 Jan 2017 
// MVA calculator for double b-tagger when CA15 btagging variable is not in the tuples already. 
// will be removed once it is available in the miniAOD(SIM)
// -----------------------------------------------------------------------------------------------
